...
public class MainGUI extends JFrame {
        ...
        private void init() {
                ...
                validGridButton.addActionListener(e -> System.out.println("Grille n° 0 : "));
                validGridButton.addActionListener(e -> grilles[0].RecupSchema());
                // validGridButton.addActionListener(e -> drawingPanels[0].testValide());
                                        ...
                                        if (drawingPanels[i].getAffiche()) {
                                                ...
                                                if (SwingUtilities.isLeftMouseButton(e)) {
                                                        ...
                                                        if (cellX >= 0 && cellX < SoftwareConfiguration.COLUMN_COUNT &&
                                                                ...
                                                                if (drawingPanels[i].getPenColor() == Color.WHITE) {
                                                                        couleurCell = false;
                                                                } else {
                                                                        couleurCell = true;
                                                                }

                                                                grilles[i].setColorie(grilles[i].cells[cellX][cellY],
                                                                                couleurCell);
